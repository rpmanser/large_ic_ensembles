...
def read_file(infile):
	...
	Analysis_time           = str(id.attrs['Analysis_time'          ])
	Analysis_time_window    = str(id.attrs['Analysis_time_window'   ])
	File_creation_date      = str(id.attrs['File_creation_date'     ])
	Grid_scheme             = str(id.attrs['Grid_scheme'            ])
	Algorithm_version       = str(id.attrs['Algorithm_version'      ])
	Algorithm_description   = str(id.attrs['Algorithm_description'  ])
	Data_source             = str(id.attrs['Data_source'            ])
	Data_source_URL         = str(id.attrs['Data_source_URL'        ])
	NOAA_wct_export_Version = str(id.attrs['NOAA_wct-export_Version'])
	Authors                 = str(id.attrs['Authors'                ])
	Project_sponsor         = str(id.attrs['Project_sponsor'        ])
	Project_name            = str(id.attrs['Project_name'           ])
	...
	data = {'name'                    : 'GridRad analysis for ' + id.Analysis_time,
			  'x'                       : x,
			  'y'                       : y,
			  'z'                       : z,
			  'Z_H'                     : Z_H,
