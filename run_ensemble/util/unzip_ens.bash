...
# ============================================================================================
# Unzip WRF ensemble members for a single initialization and forecast hour
#
# Parameters
# ----------
...
dir_unzip=${dir_scratch}/${exp}/${init}/mem${mem}/wrfoutred
...
if [[ ! -e "${dir_unzip}/${filename}" ]]; then
  echo "Unzipping ${dir_unzip}/${filename}..."
  unpigz -k ${dir_unzip}/${filename}.gz
else
  echo "${dir_unzip}/${filename} already exists. Doing nothing..."
fi
