...
#
# Create a namelist file for a WRF initialization
#
# Parameters
# ----------
#   $1 = param : absolute path to parameter file containing paths and WRF namelist variables
#   $2 = date_begin : forecast initialization date (YYYYMMDDHH)
#   $3 = date_end : final forecast date (YYYYMMDDHH)
#   $4 = dir_wrf : path to WRF run directory
#   $5 = num_metgrid_levels (optional) : number of metgrid levels. Default is 32.
#
